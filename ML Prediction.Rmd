...
```
<p>
**GBM:** The gbm model scored 99.95% accuracy with a Kappa value of 0.9994. The out-of-sample error rate is 1 - .9995 = 0.0005. Only two observations were misclassified:
```{r}
